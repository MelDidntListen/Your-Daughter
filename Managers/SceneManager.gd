...
const LEVEL_H:int = 1536	## height of levels (viewport) - only used by Zelda transition
const LEVEL_W:int = 2048	## width of levels (viewport) - only used by Zelda transition
